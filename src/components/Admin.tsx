                        ...
                        >
                            <div className="space-y-3">
                                {touristSpots.map((spot, index) => (
                                    <div
                                        key={index}
                                        className="bg-white p-4 rounded-lg shadow-sm relative spot-card border-gray-400 border-2"
                                    >
                                ...
                                >
                                    ...
                                    <div className="border-t border-gray-200 p-2 bg-gray-50">
                                        <div className="flex justify-between items-center mb-1 text-sm">
                                            ...
                                            <div
                                                className={`font-medium ${getDustColor(data.dust.fineDust)}`}
                                            >
                                                {data.dust.fineDust}
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center text-sm">
                                            ...
                                            <div
                                                className={`font-medium ${getDustColor(data.dust.ultraFineDust)}`}
                                            >
                    ...
                    <div className="flex-1 flex flex-col bg-white rounded-lg shadow-md overflow-hidden border-2">
                        ...
                        >
                            {touristInfo.map((info, index) => (
                                <div
                                    key={index}
                                    className="grid grid-cols-4 py-4 border-b hover:bg-gray-50 transition-colors"
                                >
                                    <div className="text-center text-black">
                                        {info.spotName}
                                    </div>
